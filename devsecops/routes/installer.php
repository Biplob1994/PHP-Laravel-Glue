<?php
Route::group(
    ['namespace' => 'Installer', 'prefix' => 'install', 'as' => 'SprukoAppInstaller::', 'middleware' => ['web','caninstall']], function () {
...
Route::group(
    ['namespace' => 'Installer', 'prefix' => 'update', 'middleware' => 'web', 'as' => 'SprukoUpdater::'], function () {
   
        Route::group(
            ['middleware' => 'canupdate'], function () {
