(function ($) {
    ...
    $(document).on(
        "click", ".fullscreen-button", function toggleFullScreen()
        {
    ...
    $(document).on(
        "click", "[data-bs-toggle='search']", function (e) {
            var body = $("body");
