    ...
    function () {
        ...
        jQuery(
            function () {
                ...
                jQuery('.horizontal-navtoggle').on(
                    'click', function () {
                        jQuery('body').toggleClass('active');
                    }
                );
                jQuery('.horizontal-overlapbg').on(
                    'click', function () {
                ...
                jQuery('.horizontalMenu-click').on(
                    'click', function () {
                ...
                jQuery('.horizontalMenu-click02').on(
                    'click', function () {
                ...
                jQuery('.horizontalMenu-click03').on(
                    'click', function () {
                ...
                jQuery('.horizontalMenu-click04').on(
                    'click', function () {
        ...
        jQuery(window).on(
            "load", function () {
                jQuery('.horizontal-header .wssearch').on(
                    "click", function () {
                        jQuery(this).toggleClass("wsopensearch");
                    }
                );
                jQuery("body, .wsopensearch .fa.fa-times").on(
                    "click", function () {
                        jQuery(".wssearch").removeClass('wsopensearch');
                    }
                );
                jQuery(".wssearch, .wssearchform form").on(
                    "click", function (e) {
                        e.stopPropagation();
                    }
                );
