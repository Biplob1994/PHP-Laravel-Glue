...
Route::middleware(ProtectAgainstSpam::class)->group(
    function () {

        Route::middleware(['checkinstallation'])->group(
            function () {


                Route::middleware(['admincountryblock','throttle:refresh', 'ipblockunblock','apichecking'])->group(
                    function () {
                        ...
                        Route::group(
                            ['namespace' => 'Admin', 'prefix'     => 'admin'], function () {
                                ...
                                Route::middleware('auth', 'admin.auth')->group(
                                    function () {
                                        ...
                                        Route::group(
                                            ['prefix' => 'customnotification'], function () {
                ...
                Route::middleware(['countrylistbub', 'throttle:refresh', 'ipblockunblock', 'apichecking'])->group(
                    function () {
            
        
                        Route::group(
                            ['namespace' => 'User', 'prefix' => 'customer'], function () {
                                ...
                                Route::middleware('auth:customer', 'customer.auth')->group(
                                    function () {
